...
//first update: 22/02/2015 ( Zahedul Islam Jitu ) 
...
ofstream 	Qbarfile("quarkBRaw.data");
ofstream	Bbarfile("BaryonBRaw.data");
ofstream	Qfile("quarkRaw.data");
ofstream	Bfile("BaryonRaw.data");
// Quark Mass
m=10;
// Y-Vertex Energy
v=0.0;
...
Qfile<<quark[k]<<endl;
Bfile<< baryon[k]<<endl;
Qbarfile<<antiquark[k]<<endl;
Bbarfile<< antibaryon[k]<<endl;
}
//}
return(0);
}
